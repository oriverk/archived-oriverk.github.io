...
## 実内容
### デザイン変更
[ページ表示速度](https://developers.google.com/speed/pagespeed/insights/?hl=JA)を向上させるため、メニュータブにしか使っていないBootstrap由来のJSとCSSを排除し、自作のjsスクリプトを追加した。
...
コードのシンタックスハイライトを有効化する為、Rougeを導入した。
